...
рабочей копии `/home/mazix/Documents/GitHub/dockge2` в четырех файлах старых планов и личный домен
владельца `dockge2-design-directions.xizam.chatgpt.site` в семи файлах `docs/design/`. В HEAD этого
...
`mazix@bk.ru` - его контактный адрес. Дерево HEAD после переписывания побайтно то же, что и до
