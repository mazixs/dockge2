...
**C. Состояние зафиксировано.** Работа с 31 августа лежала в рабочей копии без коммитов. Разобрана на девять коммитов по смыслу - аутентификация, MCP, доступность, Git, ход команды и журнал, модель стека, интерфейс, окружение разработки и каркас сервера, бренд и путь обновления - и помечена тегом `v2.0.0-rc.1`. Прод-тест проводится с тега. В `origin` ничего не отправлено.
