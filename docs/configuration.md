...
| `DOCKGE_ENABLE_CONSOLE` | `false` | Web console with a shell in the panel container, for owners and operators. The container holds the Docker socket, so treat this as root on the host |
