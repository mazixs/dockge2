...
manifest = {'source_url':'https://design-preview.example.invalid/', 'version':1, 'commit':commit,'exported':'2026-09-13','direction':'01 Знакомый Dockge','changes':['Presentation chooser and footer hidden','Outer frame removed','Query navigation for review only'],'files':{}}
