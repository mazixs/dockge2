...
- [ ] **Step 1: Добавить падающие проверки реального файла**
...
- [ ] **Step 2: Реализовать запись `.env` после подготовки каталога**
...
- [ ] **Step 3: Проверить права и отсутствие утечки содержимого**
...
- [ ] **Step 1: Добавить падающие round-trip-тесты**
...
- [ ] **Step 2: Перенести обнаружение octal на типизированный `Scalar`**
...
- [ ] **Step 3: Проверить YAML 1.1 побочные эффекты**
...
- [ ] **Step 4: Запустить проверки и зафиксировать результат**
...
Expected: пять небольших тематических коммитов, отсутствие изменений в исходной рабочей копии `/home/mazix/Documents/GitHub/dockge2` и отчёт с результатами всех команд.
