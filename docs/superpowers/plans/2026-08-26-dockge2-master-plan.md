...
- Актуальная рабочая копия: <workdir>. Каталога dockge2-review и ветки mzx/dependency-stack-review больше нет, их результат влит в master этого репозитория (коммиты 749e2c5, f809ae1, 276f5a6, b75a313). Прежняя запись про неизменяемую исходную копию отменена 2026-08-26.
