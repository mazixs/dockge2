...
its original vendor Compose file and a running panel. From `0.0.12`, it also accepts an unmanaged,
...
available from `0.0.12`. Do not downgrade panel data to regain the `0.0.8` path.
